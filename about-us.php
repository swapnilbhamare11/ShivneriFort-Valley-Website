        ...
        <section class="about introduction_area">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="introduction_center_text">
                            <div class="text-center intro_title">
                                <h2>About<span>Shivneri Fort Valley Resort</span></h2>
                                <p>We welcome you for an endless journey of happiness and tranquility on your trip.</p>
                            </div>
                ...
                <div class="new-row row introduction_inner">
                     <div class="col-md-6">
                        <div class="text">
                            <p style="font-size:17px;line-height: 35px;">Our resort is situated bellow the "Kadelot point" of fort Shivneri (Birthplace of Chatrapati Shivaji Maharaj).</p>
                            <p style="font-size:17px;line-height: 35px;">Resort is surrounded by mountains of sahyadri there are many tourist places nearby shivneri fort valley resort .</p>
                           
                            <p style="font-size:17px;line-height: 35px;">The resort consiste of about 4 rooms in the valley with 2 rooms having views of the shivneri fort. The atmosphere is very different from the city. Live life at its peak at Shivneri Fort Valley, where the air is soothing and the view is breathtaking. Rejuvenate your soul in the nature’s embrace.</p>
                                
                        </div>
                     </div>
                      <div class="col-md-6">
                        <img src="img/new-img/about-img1.jpg" width="100%">
                     </div>
                ...
                <div class="row choose_resot_inner">
                    <div class="col-md-5">
                        <div class="resot_list">
                            <ul>
                                <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Free parking</a></li>
                                <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Free breakfast</a></li>
                                <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Restaurant</a></li>
                                <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Breakfast available</a></li>
                                <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Pets Allowed (Dog / Pet Friendly)</a></li>
                                <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Banquet room</a></li>
                                <li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Laundry service</a></li>
