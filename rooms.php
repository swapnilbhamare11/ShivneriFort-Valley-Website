    ...
    <!--================Introduction Area =================-->
        <section class="room introduction_area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p style="font-size: 20px;color:#222;font-weight: 550;margin-bottom: 40px;">  Live life at its peak in one of the most luxurious resort in Junnar</p>
                    </div>
                </div>
                <div class="row introduction_inner">
                    <div class="col-md-7">
                        <div class="introduction_left_text">
                            ...
                            <!--<h4><span class="color"><del>Rs. 3500</del></span> &nbsp;&nbsp;Rs. 3000 /- Day</h4>
                            ...
                            <!-- <a class="about_btn_b" href="#" >Book Now</a> -->  <a class="enquiry about_btn_b" href="#" data-toggle="modal" data-target="#myModal">Enquiry</a> <a class="book-now about_btn_b" href="#" data-toggle="modal"  data-target="#myModal1">Book Now</a>
                        </div>
                    </div>
                    <div class="col-md-5">
        ...
        <!--================End Introduction Area =================-->
            <!--================Introduction Area =================-->
        <section class="roombk room introduction_area">
            <div class="container">
                <div class="row introduction_inner">
                    <div class="col-md-7">
                        <div class="introduction_left_text">
                            ...
                            <!--<h4><span class="color"><del>Rs. 3000</del></span>&nbsp;&nbsp;Rs. 2500 /- Day</h4>
                            <h5>Extra Person Rs. 700</h5><br>-->
                            <!--<p>Experience the feeling of home in one of the most luxurious resort in Junnar. Every room and suite in Shivneri Fort Valley Resort has been designed with the utmost respect for Nature, combining high-end comfort. Choose your ideal room and start your holiday with us in Junnar.</p>-->
                             <!-- <a class="about_btn_b" href="#" >Book Now</a> -->  <a class="enquiry about_btn_b" href="#" data-toggle="modal" data-target="#myModal">Enquiry</a> <a class="book-now about_btn_b" href="#" data-toggle="modal" data-target="#myModal2">Book Now</a>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="introduction_img">
