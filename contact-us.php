...
<!-- End Facebook Pixel Code -->
            ...
            <div class="container">
                <div class="row get_contact_inner">
                    <div class="col-md-6">
						...
						<!--<form action="" class="form-validation" autocomplete="off" method="post" id="contactForm" enctype="multipart/form-data"> --><div id="check1"></div>
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" id="number" name="number" placeholder="Phone no." minlength="10" maxlength="10">
                            </div>
                            <div class="form-group col-md-12">
							...
							<div id="check"></div>
                            <div class="form-group col-md-12">
                                <button type="submit" value="submit" id="btn_submit" class="btn submit_btn form-control">submit now</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-md-6">
   ...
   <!--      <section class="get_contact_area emails">
        ...
        <section>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59989.37333541464!2d73.71511973052043!3d19.994414961210335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bddeb3c54a61cd9%3A0x43af333d801b5183!2sNP%20IT%20Solutions!5e0!3m2!1sen!2sin!4v1677499297675!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
